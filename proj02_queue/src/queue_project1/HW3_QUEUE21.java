 ...
 * @author User
 */
public class HW3_QUEUE21 extends javax.swing.JFrame {
    int clickCount = 0;
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(HW3_QUEUE21.class.getName());
    ...
    public void scenario(int count){
        // Dequeue 2 items
        ITEM = QDELETE();
        monitor();

        String info = ITEM.returnInfo(count);
        
        JOptionPane.showMessageDialog(this,
        info,
        "Bag deleted successful",
            ...
            .addGroup(rPanel2Layout.createSequentialGroup()
                ...
                .addGroup(rPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(rPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(rPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new HW3_QUEUE21().setVisible(true));
    }
