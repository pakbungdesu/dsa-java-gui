 ...
 * @author User
 */
public class get_started extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(get_started.class.getName());
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(997, 481));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            hw_stack1 pi = new hw_stack1(size);
            pi.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new get_started().setVisible(true));
    }
